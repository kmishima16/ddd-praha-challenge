...
async function seed() {
  ...
  const lessonsData = [
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.database,
      name: "データベースモデリング1",
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.test,
      name: "jestで単体テストを書こう",
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.design,
      name: "基本的な設計原則",
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.frontend,
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.webBasics,
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.devPractice,
      name: "リンターを使おう",
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.infrastructure,
      name: "安全なIAMの設計を理解する",
    ...
    {
      id: ulid(),
      lessonCategoryId: categoryIds.practice,
      name: "外部APIを活用してみよう",
